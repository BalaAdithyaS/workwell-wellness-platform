                ...
                <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-5">
                  ...
                  <div className="flex flex-wrap gap-3">
                    <div className="bg-[#FDFBD4] rounded-xl px-4 py-3">
                      <p className="text-xs text-[#713600]">Mood</p>
                      <p className="font-bold text-[#38240D]">
                        {entry.mood_score ?? "—"}
                      </p>
                    </div>
                    <div className="bg-[#FDFBD4] rounded-xl px-4 py-3">
                      <p className="text-xs text-[#713600]">Stress</p>
                      <p className="font-bold text-[#38240D]">
                        {entry.stress_level ?? "—"}
                      </p>
                    </div>
                    <div className="bg-[#FDFBD4] rounded-xl px-4 py-3">
                      <p className="text-xs text-[#713600]">Burnout</p>
                      <p className="font-bold text-[#38240D]">
                        {entry.burnout_risk ?? "—"}
                      </p>
                    </div>
                    <div className="bg-[#FDFBD4] rounded-xl px-4 py-3">
                      <p className="text-xs text-[#713600]">Sentiment</p>
                      <p className="font-bold text-[#38240D]">
                        {entry.sentiment ?? "—"}
                      </p>
                    </div>
